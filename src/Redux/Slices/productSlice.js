...
const productSlice=createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        builder.addCase(fetchProducts.rejected,(state)=>{
            state.loading=false
            state.allProducts=[]
            state.error="An unknown error occured ...Please try again after sometime!!!"
        })
    }
})
export const {searchByProducts,navigateToNextPage,navigateToPrevPage}=productSlice.actions
